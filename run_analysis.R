##
## Download the zip file and unzip if it hasn't been previously downloaded.
##

if (!file.exists("getdata-projectfiles-UCI_HAR_Dataset.zip")) {
    fileUrl <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
    download.file(fileUrl, destfile = "getdata-projectfiles-UCI_HAR_Dataset.zip")
...
average_by_activity_subject <- merged.subset %>%
